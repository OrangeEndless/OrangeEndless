...
namespace OrangeEndLess
{
    ...
    {
        public event EventHandler IsCheckedChanged=new EventHandler ( ( a , b ) => { } );
        ...
        private Windows . UI . Xaml . Media . ImageSource _ImageBlack;

        public Windows . UI . Xaml . Media . ImageSource ImageBlack
        {
            get { return _ImageBlack; }
            set
            {
                _ImageBlack = value;
                if ( IsChecked )
        ...
        private Windows . UI . Xaml . Media . ImageSource _ImageWhite;

        public Windows . UI . Xaml . Media . ImageSource ImageWhite
        {
            get { return _ImageWhite; }
            set
            {
                _ImageWhite = value;
                if ( IsChecked )
