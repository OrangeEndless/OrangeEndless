...
namespace OrangeEndLess
{
    ...
    public sealed partial class About : MVVMPage
    {
        ...
        private void TBOfWencey_Tapped ( object sender , TappedRoutedEventArgs e )
        {

        }

        private void TBOfOrange_Tapped ( object sender , TappedRoutedEventArgs e )
        {
